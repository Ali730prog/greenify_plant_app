...
//
//   // Fetch the data dynamically from Firestore
//   Future<List<Map<String, dynamic>>> fetchData() async {
//     QuerySnapshot snapshot = await _firestore.collection('garden_kit').get();
...
//         ),
//         backgroundColor: AppColor.greyDADADA4D,
//         body: FutureBuilder<List<Map<String, dynamic>>>(  // Fetch data from Firestore
//           future: fetchData(),
...
//                           name: wishList[index]['name'],
//                           price: wishList[index]['price'],
//                           images: wishList[index]['images'],
//                           work: wishList[index]['work'],
//                         ),
//                       );
//                     },
//                   ),
...
class _GardenKitScreenState extends State<GardenKitScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchData() async {
    QuerySnapshot snapshot = await _firestore.collection('garden_kit').get();
    print("This is my ${snapshot.docs}");
    return snapshot.docs.map((doc) {
      print("This is my doc  $doc");
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => DetailScreen(
                                ...
                                price: int.parse(wishList[index]['price']),
                                images: wishList[index]['images'],
                                height: wishList[index]['height'],  // Make sure height is a valid number
                                width: wishList[index]['width'],    // Same for width
